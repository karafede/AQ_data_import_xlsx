function data = units(workbookFile, sheetName, range)
...
%
%   DATA = IMPORTFILE4(FILE,SHEET,RANGE) reads from the specified worksheet
%   and from the specified RANGE. Specify RANGE using the syntax
%   'C1:C2',where C1 and C2 are opposing corners of the region.%
% Example:
%   StationsDMS1 = importfile4('Stations_DM.xlsx','Units','A2:V2');
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2016/12/22 11:45:30
